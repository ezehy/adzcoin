...
{
    if(fLiteMode) return; // ignore all Adzcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Adzcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("adzcoin-privatesend");
