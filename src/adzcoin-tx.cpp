...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Adzcoin Core adzcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  adzcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded adzcoin transaction") + "\n" +
              "  adzcoin-tx [options] -create [commands]   " + _("Create hex-encoded adzcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded adzcoin transaction
