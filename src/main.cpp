...
CAmount GetBlockReward(int nPrevHeight){
  ...
  * 45% of block reward is reserved for masternodes
  *
  *
  */
...
CAmount GetMasternodePayment(int nHeight, CAmount blockValue)
{
    ...
    CAmount masterNodePayment = blockValue * 0.45;
...
/**
void addDevReward(const CChainParams& chainparams, const CScript& scriptPubKeyIn){
