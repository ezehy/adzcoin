...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AdzcoinNetwork") type = AdzcoinNetwork;
    if(strType == "AdzcoinNetworkVariable") type = AdzcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AdzcoinNetwork) s = "AdzcoinNetwork";
    if(type == AdzcoinNetworkVariable) s = "AdzcoinNetworkVariable";
