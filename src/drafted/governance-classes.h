 ...
 *
 *   // network
 *   CAdzcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.adzcoincoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAdzcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CAdzcoinNetwork(UniValue objIn)
    {
...
// // can be under: AdzcoinNetwork
// //   -- signature requirements : Key1(User)
// class CAdzcoinNetworkVariable : public CGovernanceObject
// {
// private:
