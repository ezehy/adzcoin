...
Only requiring some minor changes is adzcoin.cpp.
...
Changes to adzcoin.cpp
----------------------
adzcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
