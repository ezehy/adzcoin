...
Adzcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- AdzcoinMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as Adzcoin Core, where everyone uses
...
pay attention to for reviewers of Adzcoin Core code.

General Adzcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Adzcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
